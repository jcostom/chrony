...
Feed the container an environment variable of NTP_SERVERS with a comma delimited string of your preferred set of NTP servers, or accept the default set of time[1-4].google.com. Make sure to forward 123/udp into the container, otherwise, what's the point? Here's an example docker-compose file:
